...
// Scout: the detail sheet's scene, acting out each step of "How it works" (see the steps
// for "scout" in src/data/cv.ts). Placeholder until the story is written: it names the step.

const STEPS = ["Search", "Score", "Plan", "Feedback"];
